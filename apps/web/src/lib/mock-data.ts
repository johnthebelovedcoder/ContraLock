...
export const mockDisputes: Dispute[] = [
  {
    ...
    milestone: 'ms-2',
    raisedBy: 'user-1',
    reason: 'Frontend implementation doesn\'t meet specifications',
    evidence: [
      { filename: 'screenshot1.png', url: '/evidence/screenshot1.png', type: 'image/png', uploadedBy: 'user-1' },
      { filename: 'screenshot2.png', url: '/evidence/screenshot2.png', type: 'image/png', uploadedBy: 'user-1' }
    ],
    status: 'IN_REVIEW',
    ...
    messages: [
      {
        sender: 'user-1',
        content: 'The frontend components don\'t match the design specifications provided.',
        sentAt: new Date('2024-03-18').toISOString()
      }
    ],
    disputeFeePaid: true,
  ...
  },
  {
    ...
    milestone: 'ms-10',
    raisedBy: 'user-2',
    reason: 'Payment not processed after milestone completion',
    evidence: [
      { filename: 'email_thread.pdf', url: '/evidence/email_thread.pdf', type: 'application/pdf', uploadedBy: 'user-2' },
      { filename: 'approval_screenshot.png', url: '/evidence/approval_screenshot.png', type: 'image/png', uploadedBy: 'user-2' }
    ],
    status: 'RESOLVED',
    ...
    arbitrator: null,
    resolution: {
      decision: 'PAYMENT_RELEASED',
      amountToFreelancer: 150000, // $1500 in cents
      amountToClient: 0, // $0 in cents
      decisionReason: 'Milestone was completed as per specifications, payment released to freelancer',
      decidedBy: 'admin',
      decidedAt: new Date('2023-12-15').toISOString(),
      aiRecommended: false
    },
    messages: [
      {
        sender: 'user-2',
        content: 'Client approved milestone but payment was not released',
        sentAt: new Date('2023-12-10').toISOString()
      }
    ],
    disputeFeePaid: true,
